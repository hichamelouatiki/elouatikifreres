...
import { EdgeComputingIotArticle } from "@/components/edge-computing-iot-article";
...
const ARTICLE_SLUG = "edge-computing-iot";
...
export default async function EdgeComputingIotPage({ params }: Props) {
  const { locale } = await params;
