...
import { BimFluidesArticle } from "@/components/bim-fluides-article";
...
const ARTICLE_SLUG = "bim-fluides-coordination";
...
export default async function BimFluidesCoordinationPage({ params }: Props) {
  const { locale } = await params;
