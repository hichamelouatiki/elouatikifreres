...
import { EnveloppesHautePerformanceArticle } from "@/components/enveloppes-haute-performance-article";
...
const ARTICLE_SLUG = "enveloppes-haute-performance";
...
export default async function EnveloppesHautePerformancePage({ params }: Props) {
  const { locale } = await params;
  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <EnveloppesHautePerformanceArticle />
      <SiteFooter />
    </main>
  );
}
