...
import { InnovationAchatsArticle } from "@/components/innovation-achats-article";
...
const ARTICLE_SLUG = "innovation-achats";
...
export default async function InnovationAchatsPage({ params }: Props) {
  const { locale } = await params;
