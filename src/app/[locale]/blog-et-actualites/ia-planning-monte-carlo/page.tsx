...
import { ArticlePlanningIA } from "@/components/article-planning-ia";
...
const ARTICLE_SLUG = "ia-planning-monte-carlo";
...
export default async function IaPlanningMonteCarloPage({ params }: Props) {
  const { locale } = await params;
