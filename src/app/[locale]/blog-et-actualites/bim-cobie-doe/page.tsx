...
import { BimExecutionArticle } from "@/components/bim-execution-article";
...
const ARTICLE_SLUG = "bim-cobie-doe";
...
export default async function BimCobieDoePage({ params }: Props) {
  const { locale } = await params;
