          ...
          >
            <div className="h-full rounded-[24px] bg-gradient-to-br from-orange-500/25 to-transparent p-6">
              ...
              <CardContent className="flex items-center justify-between gap-3 px-0 pb-0">
                <span className="min-w-0 rounded-full border border-orange-400/20 bg-orange-400/10 px-4 py-2 text-sm font-semibold leading-snug text-orange-100 transition duration-300 group-hover:-translate-y-0.5 group-hover:border-orange-300/45 group-hover:bg-orange-400/15 sm:whitespace-nowrap">
                  {t("openDetail")}
                </span>
                <ChevronRight
                  className="size-5 shrink-0 text-orange-400 transition-transform group-hover:translate-x-1"
                  aria-hidden
                />
              </CardContent>
            </div>
